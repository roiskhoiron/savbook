...
class StyleConstants {
  ...
  static var stylePrimaryButton = ElevatedButton.styleFrom(
    ...
    backgroundColor: const Color(0xff52c4c5),
...
//SIGN IN PAGE
  ...
  static TextStyle signIn2style = GoogleFonts.poppins(
    fontSize: 17,
    fontWeight: FontWeight.w400,
    color: const Color(0xff3c3c4399).withOpacity(0.6),
  );

  static TextStyle hintStyle = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: const Color(0xff3c3c434d).withOpacity(0.3),
  );
  ...
  static TextStyle haventAccounStyle1 = GoogleFonts.poppins(
    fontSize: 15,
    fontWeight: FontWeight.w400,
...
//NEWS PAGE
  ...
  static InputBorder withoutUnderline = const UnderlineInputBorder(
      borderSide: BorderSide(color: Colors.transparent));

  static OutlineInputBorder borderInputCustom(
      {Color? colorBorder, double? width, double? radius}) {
    return OutlineInputBorder(
        borderSide:
            BorderSide(color: colorBorder ?? Colors.blue, width: width ?? 1.0),
